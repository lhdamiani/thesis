...
\newpage
\input{chapters/2-basic-concepts}
\newpage
\input{chapters/3-review}
\newpage
\input{chapters/4-shpeck}
\newpage
\input{chapters/5-validation}
\newpage
...
\appendix
%FIX PROBLEMS DISPLAYING THIS APPENDIX
%\input{extra/appendixA}          % Editar o arquivo apendice.tex
