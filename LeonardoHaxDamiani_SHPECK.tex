...
The understandment that overlaps in both quotes is that to achieve a \emph{software}, engineering principles (for example: management issues, directing teams, scheduling and budgeting) are necessary and will be fundamental to reach that goal.
...
\emph{UI} and \emph{HCI} were extensively studied and analysed along the software engineering of \emph{SHPECK}. 

%DOCUMENTING AND GOOD PRACTICES
\subsubsection{Documenting and Good Practices}
