...
Finally, we validate \emph{SHPECK} by modeling the diagenetic reactions observed in asiliciclastic reservoir and by performing a comparative study with other modelling software package. In addition to this, a database comparison was addressed and the results demonstrate a substantial improvement on the performance by the use of the  \emph{SHPECK}'s relational database comparing to the existent approaches.
\end{abstract}
