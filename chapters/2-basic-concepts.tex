...
a_i = \gamma_i * m_i
\end{equation}
Activity coefficient ($\gamma_i$) is explained in ~\ref{actCoeff} and is a function of ionic strenght (I), which is a measure of the concentration of ions in the solution.  
