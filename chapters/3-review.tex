...
\subsection{File formats}
The input files are regular \emph{ASCII} text files and any text editor can be used to create or edit the files.The database files from \emph{SOLMINEQ.88} have the extension "TBL" and the output files (INCOMPLETE)
