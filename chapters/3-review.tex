...
\emph{PHREEQC} stands for \emph{PH} \emph{RE}dox \emph{EQ}uilibrium in \emph{C} language, and is a widely used public-domain geochemical modelling software available from the USGS  \cite{Parkhurst:95}. 
It is available for download in versions for PC and Mac. 
